...
export default function CustomizedAccordions() {
  ...
  return (
    ...
    <div className={styles.accordionContainer1}>
      <Accordion className={styles.accordion} expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
        <AccordionSummary className={styles.accordion2} aria-controls="panel1d-content" id="panel1d-header">
      ...
      <Accordion className={styles.accordion} expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
        <AccordionSummary className={styles.accordion2} aria-controls="panel2d-content" id="panel2d-header">
      ...
      <Accordion className={styles.accordion} expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
        <AccordionSummary className={styles.accordion2} aria-controls="panel3d-content" id="panel3d-header">
